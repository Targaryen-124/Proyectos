...
@PageTitle("Puestos")
@Route(value = "puestos/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class PuestosView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "puestos/%s/edit";
    ...
    public PuestosView(SamplePersonService samplePersonService) {
